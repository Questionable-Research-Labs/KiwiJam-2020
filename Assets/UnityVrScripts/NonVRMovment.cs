...
namespace UnityVRScripts {
    ...
    public class NonVRMovment : MonoBehaviour {
        /*
    ...
    Updated by Jasper M-W to support cursor locking, hiding and 360, pausing and to only activate in lack of VR
    */
        ...
        public bool enableBackupCamera = true;
        ...
        void Update() {
            ...
            if (Input.GetButtonDown("Cancel")) {
                enableBackupCamera = !enableBackupCamera;
                mouseCaptured = !mouseCaptured;
            }

            Cursor.visible = !mouseCaptured;
        }
